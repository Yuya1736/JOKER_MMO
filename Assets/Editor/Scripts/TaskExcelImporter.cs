...
using UnityEditor;
using UnityEngine;
public static class TaskExcelImporter
{
    ...
    [MenuItem("Project/Generate/ImportExcelToTaskConfig")]
    public static void Improt()
    {
        ...
        using (ExcelPackage excelPackage = new ExcelPackage(fileInfo))
        {
            ...
            for (int x = 2; x < maxCol; x++) // 第一行是表头
            {
                ...
                //};
                taskConfig.taskName = worksheet.Cells[x, 2].Text.Trim();
                ...
                //};
                taskConfig.taskDescription = worksheet.Cells[x, 4].Text.Trim();
                ...
                taskConfig.targetPos = ConverVector3(worksheet.Cells[x, 9].Text.Trim());
